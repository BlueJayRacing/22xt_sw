    ...
    while (1) {
        ...
        while (1) {
            ...
            if (len > 0) {
                ...
                sendto(sock, recv_strftime, strlen(recv_strftime), 0, (struct sockaddr*)&source_addr,
                       sizeof(source_addr));
                ...
                sendto(sock, sent_strftime, strlen(sent_strftime), 0, (struct sockaddr*)&source_addr,
                       sizeof(source_addr));
...
// Prefer the udp_server functions instead
void wifi_connection()
{
    ...
    wifi_config_t wifi_configuration = {.ap = {.ssid = "baja", .max_connection = 5}};
